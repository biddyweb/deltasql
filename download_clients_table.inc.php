...
<tr><td><b>dbredactor</b></td><td><a href="manual.php#install-dbredactor-client"><img src="icons/help.png"></a></td><td>Eclipse (Java, Ant)</td><td>Retrieves version directly from db schema and shows synchronization script from deltasql server (for MySQL, PostgreSQL, Oracle and MS SQL Server). JDBC driver is included.</td><td><?php echo "$dbredactor_version"; ?></td><td><a href="clients/java/dbredactor.zip"><center>download...</center></a></td></tr>
