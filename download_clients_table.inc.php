...
<tr><td><b>pyclient</b></td><td><a href="manual.php#install-dbredactor-client"><img src="icons/help.png"></a></td><td>Python (Linux)</td><td>This simple Python script retrieves version directly from db schema and shows synchronization script from deltasql server or executes it into schema depending on configuration (for MySQL only). </td><td><?php echo "$pyclient_version"; ?></td><td><a href="clients/python/pyclient.tar.gz"><center>download...</center></a></td></tr>
