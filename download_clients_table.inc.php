...
<tr><td><b>deltaclient</b></td><td>Windows (Freepascal)</td><td>Multipurpose deltasql client written in Freepascal for Windows (XP, Vista, 7).
...
<tr><td><b>dbredactor</b></td><td>Eclipse (Java, Ant)</td><td>Retrieves version directly from db schema and shows synchronization script from deltasql server (for MySQL, PostgreSQL, Oracle, MS SQL Server and Sybase). JDBC driver included.</td><td><?php echo "$dbredactor_version"; ?></td><td><a href="clients/java/dbredactor.zip"><center>download...</center></a></td></tr>
