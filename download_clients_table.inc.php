...
<tr><td><b>deltaclient</b></td><td><a href="manual.php#install-deltaclient-linux"><img src="icons/help.png"></a></td><td>Linux (Freepascal)</td><td>Multipurpose deltasql client written in Freepascal (for Linux). It is the client explained on the line above, but compiled for Linux on the x86 architecture. Tested on Ubuntu with Unity and on Debian with Gnome.</td><td><?php echo "$deltaclient_linux_version"; ?></td><td><a href="clients/freepascal/deltaclien_linux.zip"><center>download...</center></a></td></tr>
