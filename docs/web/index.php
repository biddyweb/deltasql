...
<h3>Features</h3>
<ul>
<li>Deltasql server manages SQL scripts which alter database structure 
and contents. 
It  
organizes scripts in modules, which can be grouped in projects. It 
allows to search among them.</li>
<li>Database synchronization by adding special synchronization 
...
PostgreSQL).</li>
<li>Several teams of developers can manage several projects and several 
databases.</li>
<li>Ability to manage development schemas and production schemas by 
...
script stored in a separate file.</li>
...
<li>Google Gadget shows latest submitted scripts on 
iGoogle homepage.</li>
